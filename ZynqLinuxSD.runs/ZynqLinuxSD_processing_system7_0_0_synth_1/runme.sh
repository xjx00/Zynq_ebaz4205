...
HD_PWD='E:/ZYNQ/ZynqLinuxSD/ZynqLinuxSD/ZynqLinuxSD.runs/ZynqLinuxSD_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZynqLinuxSD_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZynqLinuxSD_processing_system7_0_0.tcl
