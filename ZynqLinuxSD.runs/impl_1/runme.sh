...
HD_PWD='E:/ZYNQ/ZynqLinuxSD/ZynqLinuxSD/ZynqLinuxSD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ZynqLinuxSD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ZynqLinuxSD_wrapper.tcl -notrace
