...
################################################################
# This is a generated script based on design: ZynqLinuxSD
#
...
proc create_root_design { parentCell } {
  ...
  set eth0_rxd [ create_bd_port -dir I -from 3 -to 0 eth0_rxd ]
  set eth0_txd [ create_bd_port -dir O -from 3 -to 0 eth0_txd ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_MIO_TREE_SIGNALS {unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#tx#rx#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#clk#cmd#data[0]#data[1]#data[2]#data[3]#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned} \
  ...
  connect_bd_net -net In0_0_1 [get_bd_ports eth0_rxd] [get_bd_pins xlconcat_1/In0]
  ...
  connect_bd_net -net xlconcat_0_dout [get_bd_ports eth0_txd] [get_bd_pins xlconcat_0/dout]
